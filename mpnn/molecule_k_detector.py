...
class MoleculeKDetector(torch.nn.Module):
    def __init__(self):
        super().__init__()
        ...
        # A.1: Carbon with >= three neighbours and no hydrogens.
        ...
        # B.1: Oxygen with double bond to a carbon
        ...
        # C.1: Carbon with 2 carbon neighbours and 2 hydrogens.
