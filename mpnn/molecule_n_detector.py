...
class MoleculeNDetector(torch.nn.Module):
    def __init__(self):
        super().__init__()
        ...
        # A.1: Carbon with 3 neighbours (single bond), bonded to a single hydrogen.
        ...
        # B.1: Carbon with a CH3 neighbour, being itself bonded to a single hydrogen.
