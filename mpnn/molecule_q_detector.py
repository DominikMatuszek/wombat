...
class MoleculeQDetector(torch.nn.Module):
    def __init__(self):
        super().__init__()
        ...
        # A.1: Carbon with 2 single-bond neighbours and 2 hydrogens.
        ...
        # B.1: Carbon with a Cl neighbour, being itself bonded to 2 hydrogens.
        substructure_b_1_detector_weights = (
            one_hot_encode(100, 6) + exactly_two_hydrogens_check_weights,
            one_hot_encode(110, 17),
            one_hot_encode(4, 0),
            0
        )
